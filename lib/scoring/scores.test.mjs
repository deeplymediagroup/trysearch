...
describe("difficulty", () => {
  ...
  it("reports saturation and title match in parts for the breakdown popover", () => {
    ...
    // Zero-weighted in the fitted value (52-pair fit) but still explained to the user.
    expect(d.parts.saturation).toBeGreaterThan(50);
    expect(typeof d.parts.titleMatch).toBe("number");
  });
